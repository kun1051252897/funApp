...
class GridItemDecoration(
    ...
    private var dividerHorSize: Int = 10,//横向线宽度
    private var dividerVerSize: Int = 10,//纵向线宽度
    private var dividerSize: Int = -1,//设置dividerSize，则覆盖horSize和verSize的值
    private var orientation: Int = VERTICAL,
    private var horColor: Int = Color.parseColor("#dddddd"),//横向线颜色
    private var verColor: Int = Color.parseColor("#dddddd"),//纵向线颜色
    private var dividerColor: Int = -1,//设置dividerColor，则覆盖horColor和verColor的值
    private var marginColor: Int = Color.parseColor("#dddddd")//屏幕四周间隔颜色
